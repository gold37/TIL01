...
public class PostMethodTest2 extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		throws IOException {
		// 메소드를 호출하는 측에서 예외처리를 하겠다.
		

		System.out.println(">>> 확인용 : doGet(request, esponse) 메소드 호출됨 ");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
		...
		System.out.println(">>> 확인용 : doPost(request, esponse) 메소드 호출됨 ");
		...
		*/
		...
		System.out.println("color => " + color); 	// color => blue
