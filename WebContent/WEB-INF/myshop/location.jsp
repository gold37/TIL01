...
<div id="map" style="width:90%; height:450px;"></div>
   ...
   <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=a4771c42be8b0cd98ac0c685601d1979"></script> 

   <script>
   
      $(document).ready(function(){ 
         
   		// 지도를 담을 영역에 DOM 레퍼런스가 필요 ( 지도를 어디에 뿌릴래? -> 나는 map )
   		...
   		var options = {
   				center: new kakao.maps.LatLng(37.56602747782394, 126.98265938959321), // 지도의 중심좌표. 반드시 존재해야함.
   	 			// 가운데를 어디할래?					     위도(가로) 			     경도(세로)
   	 			level: 4 // 지도의 레벨(확대, 축소 정도). 숫자가 적을수록 확대됨
         ...
         */
         ...
         $.ajax({
        	...
        	async:false, // !!!! 지도는 비동기 통신(true)이 아닌 동기 통신(false)으로 해야한다 !!!!
        	dataType:"json",
        	success:function(json){
        		...
        		$.each(json, function(index, item){
					...
					positionArr.push(position); // 객체를 배열 속에 넣기
        		});
