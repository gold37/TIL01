...
<jsp:forward page="03forwardCalcView_EL.jsp"/> <!-- 뷰단 찍어줌 -->
<%-- 웹브라우저 상에서 URL 주소는 그대로 /MyMVC/ch04_StandardAction/03forwardCalc_EL.jsp 인데
	  웹브라우저 상에 보여지는 내용물은 /MyMVC/ch04_StandardAction/03forwardCalcView_EL.jsp의 내용이 보여진다.  --%>
